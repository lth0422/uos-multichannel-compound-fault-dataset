...
- 후속 S1 기반 확장 분석에서 단일 B의 `2×BSF−FTF`가 37.5% 검출되어 기본 BSF만으로 판단한 기존 분석의 한계 확인됨
...
## 3. 공회전 제외 후 ADC 포화 전수 검사

- 원시 파일 전체 표본 수: 2,535,751,736개
- 판정에 사용한 유효 측정구간 표본 수: 1,425,408,000개
- 유효 측정구간의 정확한 ADC 포화 표본 수: 2,675개
- 유효 측정구간 표본 대비 비율: 약 0.0001877%
- ADC 포화 포함 파일: 45/116개
- 50 g 초과 포함 파일: 46/116개
- 최장 연속 포화: 3표본, 약 117 μs
- 최악 채널: `N204/1400 RPM/M3/IR+OR+B/CH0`
- 최악 채널의 포화 표본 수와 비율: 438개·약 0.01426%
...
- 다른 채널이 하나 이상 함께 크게 반응한 사건: 1,823/1,967건, 92.7%
- 다른 채널이 둘 이상 함께 크게 반응한 사건: 1,262/1,967건, 64.2%
...
- 베어링 복합 결함 파일: 총 60개, ADC 포화 파일 45개
- 단순 규칙: ADC 포화가 있으면 복합 결함으로 판정함
- 전체 116파일 정확도: 101/116 = 87.1%
- 전체 precision: 45/45 = 100%
- 전체 recall: 45/60 = 75.0%
- 조건 구성이 균형적인 30204·1600 RPM 64파일 정확도: 59/64 = 92.2%
- 30204·1600 RPM precision: 100%
- 30204·1600 RPM recall: 27/32 = 84.4%
...
| 1400 | 12 | 1398.75 | 1400.63 | 1402.50 |
| 1600 | 72 | 1597.50 | 1601.25 | 1605.00 |

### 6.2 해석

- 116파일 모두 설정 회전수와 큰 차이 없는 1× 후보 확인됨
- 네 채널 일치도와 피크 분리도를 기준으로 High 114파일, Medium 2파일 판정됨
...
|---|---:|---|---:|
| 30204 | 600 | OR, IR+OR+B | 51/64 |
| 30204 | 1400 | IR+OR+B | 8/16 |
| 30204 | 1600 | OR, OR+B, IR+OR, IR+OR+B | 71/128 |
| 6204 | 1400 | IR+OR+B | 0/16 |
| 6204 | 1600 | IR+OR+B | 8/16 |
...
- 모든 베어링을 합친 `138/272`만으로 OR 검증 성공을 주장하면 안 됨

### 8.2 IR 결함의 BPFI 검출

| 베어링 | RPM | IR가 포함된 베어링 결함 조건 | 검출 채널/분석 채널 |
|---|---:|---|---:|
| 30204 | 600 | IR, IR+OR+B | 44/64 |
| 30204 | 1400 | IR+OR+B | 7/16 |
| 30204 | 1600 | IR, IR+B, IR+OR, IR+OR+B | 113/128 |
| 6204 | 1400 | IR+OR+B | 4/16 |
| 6204 | 1600 | IR+OR+B | 9/16 |
| N204 | 1400 | IR+OR+B | 0/16 |
| N204 | 1600 | IR+OR+B | 0/16 |
...
- 30204·1600 RPM의 IR+OR+B에서도 27/32채널 검출됨
...
| 30204 | 1600 | B, IR+B, OR+B, IR+OR+B | 6/128 |
| 6204 | 1400 | IR+OR+B | 0/16 |
| 6204 | 1600 | IR+OR+B | 0/16 |
| N204 | 1400 | IR+OR+B | 0/16 |
| N204 | 1600 | IR+OR+B | 0/16 |
...
- 전체 6건의 검출은 모두 30204·1600 RPM IR+B에서 나타남
...
- 후속 확장 분석에서 30204·1600 RPM 단일 B의 `2×BSF−FTF`가 12/32채널에서 검출됨
...
- BPFO: 2–7 kHz와 7–10 kHz 50.7%, 10–11.2 kHz 51.1% 검출됨
- BPFI: 2–7 kHz 65.1%, 7–10 kHz 62.9%, 10–11.2 kHz 52.2% 검출됨
- BSF: 2–7 kHz 2.5%, 7–10 kHz 0.4%, 10–11.2 kHz 2.9% 검출됨
- 조건별 근거는 앞의 2–7 kHz 세부 표를 우선 사용해야 함

## 10. 왼쪽 대역 에너지 그래프 설명

- 분석 구간: 각 파일의 유효 측정구간 중 앞 10초임
- 초록색: ADC 포화가 한 번도 없는 71파일의 284채널 기록 중앙값임
- 빨간색: ADC 포화가 한 번 이상 있는 45파일의 180채널 기록 중앙값임
- 각 값: 해당 대역으로 필터링한 신호의 제곱평균을 중심화 원신호 제곱평균으로 나눈 비율임
- ADC 포화 파일의 2–7 kHz 중앙값: 31.7%
- ADC 포화 파일의 7–10 kHz 중앙값: 24.9%
- ADC 포화 파일의 10–11.2 kHz 중앙값: 12.9%
- ADC 포화 파일의 0.5–2 kHz 중앙값: 8.0%
...
- 2–7 kHz에서 BPFO 15 dB 오검출: 0/64채널임
...
- 분석 대상: 포화 사건이 5개 이상인 채널 35개임
- 비교 주파수: 1×, FTF, BSF, BPFO, BPFI임
- 위상 집중도 중앙값: 1× 0.170, BSF 0.168, BPFO 0.209, BPFI 0.203임
- 근사 `p<0.01`: 1× 1개, BSF 1개, BPFO 0개, BPFI 0개 채널임
...
| CLIP-E08 | `results/analysis_window_manifest.csv` |
...
- 원시 TDMS 수정 없음
- 공통 구간 선택 코드: `scripts/uos_v2_measurement_window.py`
- 일반 파일은 60~180초, 30204·7분 초과 파일은 300~420초만 판정에 사용함
- 대역·포락선 분석은 해당 유효 측정구간 중 앞 10초 사용함
